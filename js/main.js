(function() {
    ...
    function init() {
        ...
        // 未实现
        ui.onshowNo = ui.onshowcore = ui.onshowmore = ui.onshare = function() {
            alert('bilibili干杯~');
        }
		//奖杯
		ui.onshowcup = function() {
            alert('┗( ▔, ▔ )┛ 点什么点？奖杯不可能是你的，略略略~');
        }
		//更多
		ui.onshowmore = function() {
            alert('关注“厨房有只偷吃的猫”up主，有更多惊喜呦~');
        }
		//排行榜
		ui.onshowcore = function() {
            alert('┗( ▔, ▔ )┛，你是99999999999名，请继续加油！');
        }
